<template>
    <div>
        ...
        <form @submit.prevent="handleSubmit">
            ...
            <div class="form-group">
                <button class="btn btn-primary bg-info mt-3" :disabled="status.registering">Register</button>
                ...
                <router-link to="/login" class="btn btn-link text-info mt-3">Cancel</router-link>
            </div>
        </form>
    </div>
</template>
